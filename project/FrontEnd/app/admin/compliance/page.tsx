  ...
  return (
    <DashboardLayout>
      <div className="space-y-8">
        <div>
          <h1 className="text-xl sm:text-3xl font-bold text-[#1F1F1F]">Compliance</h1>
          <p className="font-helvetica text-[#4B4B4B] text-md sm:text-lg mt-2">Monitor and manage compliance requirements</p>
        </div>
